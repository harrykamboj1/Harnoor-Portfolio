    ...
    <div className="h-20 flex items-center md:justify-evenly justify-between text-xl sticky top-0 z-10">
      ...
      {isOpen && (
        <ul
          ...
          }  gap-[16px] flex justify-start transition-all rounded-[8px] shadow-2xl	 delay-75 ease-in-out  flex-col pt-3 pr-10 pb-6 pl-10 absolute top-[80px] right-0 bg-transparent	 bg-customDarkPurple/10 md:hidden  list-none `}
        >
