...
const Navbar = () => {
  ...
  return (
    <div
      className={`h-20 flex items-center md:justify-evenly justify-between text-xl md:static sticky top-0 z-10  transition-transform duration-300 ${
    ...
    >
      ...
      {isOpen && (
        <ul
          ...
          } gap-[16px] flex justify-start transition-all rounded-[8px] shadow-2xl delay-75 ease-in-out flex-col pt-3 pr-10 pb-6 pl-10 absolute top-[80px] right-0 bg-customDarkPurple md:hidden list-none`}
        >
          <a
